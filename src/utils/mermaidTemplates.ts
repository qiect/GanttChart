import type { GanttTemplate, TemplateCategoryInfo, TemplateCategory } from '../types'
...
export function getTemplatesByCategory(category: TemplateCategory): GanttTemplate[] {
  return ganttTemplates.filter(t => t.category === category)
}

export function getTemplateCount(category: TemplateCategory): number {
