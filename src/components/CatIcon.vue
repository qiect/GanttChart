<template>
  <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round">
    <!-- 项目管理 -->
    ...
    <!-- 商业运营 -->
    <template v-else-if="name === 'business'">
    ...
    <!-- 技术开发 -->
    <template v-else-if="name === 'tech'">
      <path stroke-width="2" d="M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
    </template>
    <!-- 人力资源 -->
    <template v-else-if="name === 'hr'">
    ...
    <template v-else-if="name === 'education'">
      ...
      <path stroke-width="2" d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z" />
    </template>
    <!-- 活动策划 -->
    ...
    <!-- 规划计划 -->
    <template v-else-if="name === 'planning'">
      <path stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
    </template>
  </svg>
</template>
