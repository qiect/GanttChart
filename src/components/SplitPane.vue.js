...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...{ style: (__VLS_ctx.isMobile ? { height: `${__VLS_ctx.ratio * 100}%` } : { width: `${__VLS_ctx.ratio * 100}%` }) },
...
// @ts-ignore
[onMouseMove, onMouseUp, onMouseUp, onMouseUp, onTouchMove, isMobile, isMobile, isMobile, isMobile, isMobile, isMobile, ratio, ratio, ratio, ratio, onMouseDown, isDragging, isDragging, isDragging, isDragging, isDragging, isDragging, onRowMouseDown, onRowTouchStart,];
