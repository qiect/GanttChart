...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...{ class: "h-12 flex items-center justify-between px-3 md:px-5 border-b" },
    ...{ style: ({
...
if (!__VLS_ctx.isMobile) {
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
        ...{ onClick: (...[$event]) => {
                ...
                // @ts-ignore
                [theme, theme, $emit, chartElement, code,];
            } },
        ...{ onMouseenter: (...[$event]) => {
                if (!(!__VLS_ctx.isMobile))
                    return;
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
        ...
        ...{ class: "premium-btn p-2 rounded-lg cursor-pointer" },
        ...{ style: ({ color: 'var(--text-secondary)' }) },
        title: "模板",
    });
    /** @type {__VLS_StyleScopedClasses['premium-btn']} */ ;
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
        ...{ onClick: (...[$event]) => {
                ...
                __VLS_ctx.$emit('themeChange', __VLS_ctx.theme === 'dark' ? 'light' : 'dark');
                // @ts-ignore
                [theme, theme, $emit, handleImport, chartElement, code,];
            } },
        ...{ class: "premium-btn p-2 rounded-lg cursor-pointer" },
        ...{ style: ({ color: 'var(--text-secondary)' }) },
        title: "切换主题",
